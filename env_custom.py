...
class CustomTradingEnv(gym.Env):
    ...
    def __init__(self, df, main_tickers, all_tickers, max_assets_amount_per_trade, technical_indicator_list,
                 initial_amount,
                 turbulence_threshold=None, reward_scaling=1, comission_value=None, transaction_price_threshold=None, if_discrete=False):
