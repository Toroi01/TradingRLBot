...
# Adding the indicators using the package ta. The default indicators are the one selected after have analyed the correlation.
def add_indicators(df, indicators = ['atr', 'bbm', 'bbw', 'bbp', 'bbhi', 'bbli','kcp', 'kchi','kcli']):
